...
def login():
    ...
    elif usernameEntry.get()=='sheetal' and passwordEntry.get()=='1234':
...
# Design the login system in this project
window = Tk()
...
usernameLabel=Label(loginFrame,image=passwordImage,text='Password',compound=LEFT,font=('times new roman',20,'bold'),
                    bg='white')
...
loginButton=Button(loginFrame,text='Login',width=15,font=('times new roman',14,'bold'),fg='white',
